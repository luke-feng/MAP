  ...
  <div class="content midover">
    ...
    <div class="md-layout">
      <div class="md-layout-item  md-size-90">
        <alert>
          <h4 >User Incident Adversary Analsis</h4>
        </alert>
      </div>
    </div>
        <div class="md-layout">
    ...
    <div class="md-layout">
      ...
      <div class="md-layout-item morebottonsize viewm" >
        <md-menu>
        <md-button md-menu-trigger class=' md-raised toggle' to="/userview">Back to Userview</md-button>
        </md-menu>
      </div>
    </div>
  </div>
...
export default {
  ...
  mounted: async function () {
    ...
    this.fillmalwaretypeData(this.organizationid)
  },
  methods: {
    onItemClick (e, i) {
    ...
    fillattackerinfrastructureData (event) {
      let url = `${shinebaseurl}/attackinfo/api/YearlyTopAttackerInfrastructure/org/` + event
      this.$axios.get(url)
        .then((res) => {
    ...
    fillthreatactorData (event) {
      this.$axios.get(`${shinebaseurl}/attackinfo/api/YearlyTopThreatActorType/org/` + event)
        .then((res) => {
          let results = res.data
          let res1 = []
          let res2 = []
    ...
    fillattackertoolData (event) {
      this.$axios.get(`${shinebaseurl}/attackinfo/api/YearlyTopAttackerTool/org/` + event)
        .then((res) => {
          let results = res.data
          let res1 = []
          let res2 = []
    ...
    fillmalwaretypeData (event) {
      this.$axios.get(`${shinebaseurl}/attackinfo/api/YearlyTopMalwareType/org/` + event)
        .then((res) => {
          let results = res.data
          let res1 = []
          let res2 = []
