  ...
  <div class="content midover">
    ...
    <div class="md-layout">
      <div class="md-layout-item  md-size-90">
        <alert>
          <h4 >User Incident Impact Analsis</h4>
        </alert>
      </div>
    </div>
    <div class="md-layout">
...
export default {
  ...
  mounted: async function () {
    ...
    this.filllosspropertyData(this.organizationid)
    this.filllossdurationData(this.organizationid)
  },
  methods: {
    onItemClick (e, i) {
    ...
    filllosspropertyData (event) {
      this.$axios.get(`${shinebaseurl}/attackinfo/api/YearlyTopLossProperty/org/` + event)
        .then((res) => {
          let results = res.data
          let res1 = []
          let res2 = []
    ...
    filllossdurationData (event) {
      this.$axios.get(`${shinebaseurl}/attackinfo/api/YearlyLossDuration/org/` + event)
        .then((res) => {
          let results = res.data
          let res1 = []
          let res2 = []
